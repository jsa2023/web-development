...
function verifyPresentInLabel(label1, label2) {
  ...
  if (!lab1 | !lab2) {
    output =
      "The value should be seconds, minutes, hours, days, second, minute, hour, day";
  }
}
...
const timeAdd = timeAdder(1,'hours', 3, 'minutes');

// const timeAdd = timeAdder(2,'hours', 3, 'minutes');
// const timeAdd = timeAdder(1,'minute', 3, 'minutes');
